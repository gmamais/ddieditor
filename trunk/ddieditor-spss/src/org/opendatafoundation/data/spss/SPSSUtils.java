...
public class SPSSUtils {
	...
	/**
	 * Converts a numeric value representing a date/time in SPSS into a Java
	 * GregorianCalendar. Date/time in SPSS are stored as the number of seconds
	 * elapsed since midnight on October 14th 1582 (start of the Gergorian
	 * calendar)
	 * 
	 * @param value
	...
	public static GregorianCalendar numericToCalendar(double value) {
		...
		value -= 12219379200.0; // Change date baseline from midnight on October
								// 14th 1582 to January 1st 1970
		...
		// 86400.0)+"="+daysOffset+"["+hoursOffset+":"+minutesOffset+":"+secondsOffset+"."+hundredsOffset+"]\n");
